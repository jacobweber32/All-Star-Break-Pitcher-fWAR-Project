---
title: "Rest of Season Prediction Using Standard Stats"
author: "Jacob Weber"
date: "2024-07-18"
output:
  html_document:
...
model_data <- all_data %>%
  ...
  mutate(
    ERA_inv = inverse_metric(ERA),
    FIP_inv = inverse_metric(FIP),
    WHIP_inv = inverse_metric(WHIP)
  ) %>%
  na.omit()
```
...
model_features <- c("Age", "IP", "K_pct", "BB_pct", "ERA_inv", "FIP_inv", "BABIP", "GB_pct", "FB_pct", "WHIP_inv")
